/**
 * src/modules/comparison/components/ImageUploader.tsx
 * ─────────────────────────────────────────────────────────────────────────────
 * Dual-image (Before & After) upload component with drag-and-drop, camera
 * capture, GPS geotagging, and watermark embedding.
 * Relocated from Arcolab/frontend/src/components/ImageUploader.tsx
 * Adaptation: no import changes needed (only lucide-react used). Logic unchanged.
 */
