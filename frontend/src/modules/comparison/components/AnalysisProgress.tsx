/**
 * src/modules/comparison/components/AnalysisProgress.tsx
 * ─────────────────────────────────────────────────────────────────────────────
 * Animated multi-step progress indicator for the 5S Comparison analysis pipeline.
 * Relocated from Arcolab/frontend/src/components/AnalysisProgress.tsx
 * Adaptation: import path for types updated to comparison module. Logic unchanged.
 */

import { Loader2, CheckCircle2, AlertTriangle, RefreshCw } from "lucide-react";
import type { AnalysisPipelineState, AnalysisStage } from "@/modules/comparison/types/comparison";
...
const STAGE_LABELS: Record<AnalysisStage, string> = {
  ...
  saving: "Saving comparison record",
