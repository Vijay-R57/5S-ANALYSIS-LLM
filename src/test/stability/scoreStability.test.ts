...
import { scoreSession, scorePillar } from '@/../supabase/functions/analyze-5s/scoring/ScoringService';
...
import { applyBuiltinRules } from '@/../supabase/functions/analyze-5s/ai/RuleEngine';
import type { QuestionItem, ScoredResponse, CriticalRule } from '@/../supabase/functions/analyze-5s/scoring/types';
import type { StructuredObservation } from '@/../supabase/functions/analyze-5s/ai/ObservationCache';
